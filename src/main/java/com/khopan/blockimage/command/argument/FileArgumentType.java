...
public class FileArgumentType implements ArgumentType<File> {
	...
	private static final SimpleCommandExceptionType ERROR_INVALID_PATH = new SimpleCommandExceptionType(Component.translatable("error.command.blockimage.invalid_path"));
	private static final SimpleCommandExceptionType ERROR_PATH_NOT_ABSOLUTE = new SimpleCommandExceptionType(Component.translatable("error.command.blockimage.path_not_absolute"));
	private static final SimpleCommandExceptionType ERROR_PATH_NOT_FOUND = new SimpleCommandExceptionType(Component.translatable("error.command.blockimage.path_not_found"));
	private static final SimpleCommandExceptionType ERROR_PATH_MUST_BE_FILE = new SimpleCommandExceptionType(Component.translatable("error.command.blockimage.path_must_be_file"));
	private static final SimpleCommandExceptionType ERROR_EXPECTED_STRING_TERMINATOR = new SimpleCommandExceptionType(Component.translatable("error.command.blockimage.expected_string_terminator"));
	...
	public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
		try {
			...
			BlockImage.LOGGER.warn("Command suggestion error: " + Errors.getMessage());
